...
$articles = @(
  ...
  @{
    ...
    Alts  = @("Как работает товарный фид от каталога до покупателя", "Структура рекламы интернет-магазина в Яндекс Директе", "Оценка эффективности рекламы интернет-магазина по расходам, покупкам, выручке и ДРР")
  },
  @{
