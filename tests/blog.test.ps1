...
$articles = @(
  @{
    Slug  = "yandex-direct-kommercheskaya-nedvizhimost"
    Title = "Яндекс Директ для коммерческой недвижимости: настройка рекламы и заявки"
    Desc  = "Как настроить Яндекс Директ для коммерческой недвижимости: Поиск, РСЯ, сегментация объектов, посадочные страницы, аналитика и реальный кейс со снижением стоимости лида."
    Images = @("yandex-direct-kommercheskaya-nedvizhimost-1", "yandex-direct-kommercheskaya-nedvizhimost-2", "yandex-direct-kommercheskaya-nedvizhimost-3")
    CardImage = "yandex-direct-kommercheskaya-nedvizhimost"
    Alts  = @(
      "Схема рекламы коммерческой недвижимости в Поиске и РСЯ",
      "Снижение стоимости лида коммерческой недвижимости с 6000 до 1700 рублей",
      "Воронка заявок из Яндекс Директа для коммерческой недвижимости"
    )
  },
  @{
    Slug  = "yandex-direct-dlya-stroitelnoy-kompanii"
    Title = "Яндекс Директ для строительной компании: как получать заявки на строительство"
    Desc  = "Как настроить Яндекс Директ для строительной компании: поиск, РСЯ, посадочные страницы, аналитика, квалификация лидов и реальные примеры рекламных проектов."
    Images = @("01-kak-rabotaet-reklama-dlya-stroykompanii", "02-posadochnaya-stranitsa-dlya-stroykompanii", "03-kachestvo-zayavok-put-k-dogovoru")
    CardImage = "yandex-direct-dlya-stroitelnoy-kompanii"
    Alts  = @(
      "Как работает реклама для строительной компании: поиск, РСЯ и заявка",
      "Посадочная страница строительной компании: проекты, цена и заявка",
      "Путь от заявки до квалифицированного лида и договора в строительстве"
    )
  },
  @{
    Slug  = "yandex-direct-dlya-online-shkoly"
    Title = "Яндекс Директ для онлайн-школы: как получать заявки на обучение"
    Desc  = "Как настроить Яндекс Директ для онлайн-школы: Поиск, РСЯ, воронки, посадочные страницы, аналитика, оптимизация и реальные кейсы образовательных проектов."
    Images = @("1-voronka-online-shkoly-yandex-direct", "2-analitika-voronki-online-shkoly", "3-poisk-i-rsya-online-shkola")
    CardImage = "yandex-direct-dlya-online-shkoly"
    Alts  = @(
      "Воронка Яндекс Директа для онлайн-школы от рекламы до оплаты обучения",
      "Аналитика воронки онлайн-школы от рекламного перехода до продажи",
      "Поиск и РСЯ в Яндекс Директе для онлайн-школы"
    )
  },
  @{
    Slug  = "yandex-direct-dlya-nedvizhimosti"
    Title = "Яндекс Директ для недвижимости: как получать заявки на квартиры, ЖК и коммерческие объекты"
    Desc  = "Как настроить Яндекс Директ для недвижимости: Поиск, РСЯ, сегментация объектов, посадочные страницы, аналитика и реальные кейсы по жилой и коммерческой недвижимости."
    Images = @("yandex-direct-nedvizhimost-1-structure", "yandex-direct-nedvizhimost-2-funnel", "yandex-direct-nedvizhimost-3-search-rsya")
    CardImage = "yandex-direct-nedvizhimost"
    Alts  = @(
      "Структура рекламных кампаний для недвижимости в Яндекс Директе",
      "Воронка аналитики рекламы недвижимости от клика до сделки",
      "Поиск и РСЯ для продвижения недвижимости в Яндекс Директе"
    )
  },
  @{
    Slug  = "reklama-psihologicheskogo-centra"
    Title = "Реклама психологического центра: Яндекс Директ, Карты и привлечение клиентов"
    Desc  = "Как рекламировать психологический центр: Поиск Яндекса, РСЯ, Карты, посадочные страницы, аналитика, ограничения рекламы и реальный кейс с лидами дешевле 700 ₽."
    Images = @("reklama-psihologicheskogo-centra-1", "reklama-psihologicheskogo-centra-2", "reklama-psihologicheskogo-centra-3")
    CardImage = "reklama-psihologicheskogo-centra"
    Alts  = @("Каналы рекламы психологического центра в Яндексе", "Воронка рекламы психологического центра от клика до записи", "Результаты рекламы центра психологии в Яндекс Директе")
  },
  @{
    Slug  = "prodvizhenie-psihologicheskogo-centra"
    Title = "Продвижение психологического центра: как привлекать клиентов из поиска и рекламы"
    Desc  = "Как продвигать психологический центр: сайт и SEO, Яндекс Директ, Карты, контент, отзывы и аналитика. Практическая схема привлечения клиентов для центра с несколькими специалистами."
    Images = @("prodvizhenie-psihologicheskogo-centra-1", "prodvizhenie-psihologicheskogo-centra-2", "prodvizhenie-psihologicheskogo-centra-3")
    CardImage = "prodvizhenie-psihologicheskogo-centra"
    Alts  = @("Схема продвижения психологического центра от запроса до записи", "Сегментация рекламы психологического центра по направлениям", "Воронка аналитики рекламы психологического центра")
  },
  @{
    Slug  = "nastroyka-direkta-dlya-internet-magazina"
    Title = "Настройка Директа для интернет-магазина: пошаговая схема запуска"
    Desc  = "Как настроить Яндекс Директ для интернет-магазина: аналитика, фид, товарные объявления, ЕПК, стратегия, сегментация товаров и оптимизация рекламы по продажам."
    Images = @("01-tovarnyy-fid-v-reklamu", "02-tovarnaya-kampaniya-ili-epk", "03-etapy-nastroyki-reklamy")
    CardImage = "nastroyka-direkta-dlya-internet-magazina"
    Alts  = @("Как товарный фид попадает в рекламу", "Сравнение Товарной кампании и ЕПК", "Этапы настройки рекламы интернет-магазина")
  },
  @{
    Slug  = "prodvizhenie-reklamnogo-proizvodstva"
    Title = "Продвижение рекламного производства: как получать заявки на вывески и наружную рекламу"
    Desc  = "Как продвигать рекламно-производственную компанию: Яндекс Директ, SEO, посадочные страницы, портфолио, аналитика и реальный кейс производства наружной рекламы."
    Images = @("01-napravleniya", "02-posadochnaya-stranica", "03-case-cpl")
    CardImage = "prodvizhenie-reklamnogo-proizvodstva"
    Alts  = @(
      "Что продвигать отдельно: вывески, буквы, короба и рекламные конструкции",
      "Как работает посадочная страница для рекламного производства",
      "Кейс: снижение стоимости лида для производства наружной рекламы с 1500 до 400 рублей"
    )
  },
  @{
    Slug  = "contextnaya-reklama-internet-magazina"
    Title = "Контекстная реклама интернет-магазина: настройка Яндекс Директа для продаж"
    Desc  = "Как настроить контекстную рекламу интернет-магазина: товарные кампании, фид, Поиск, РСЯ, Яндекс Метрика, ДРР, аналитика и реальные примеры продвижения."
    Images = @("contextnaya-reklama-internet-magazina-1", "contextnaya-reklama-internet-magazina-2", "contextnaya-reklama-internet-magazina-3")
    CardImage = "contextnaya-reklama-internet-magazina"
    Alts  = @("Схема работы товарного фида: каталог, YML-фид, объявление и покупка", "Структура рекламы интернет-магазина в Яндекс Директе", "Оценка эффективности рекламы интернет-магазина по расходам, покупкам, выручке и ДРР")
  },
  @{
    Slug  = "nastroyka-reklamy-onlayn-shkoly"
    Title = "Настройка рекламы онлайн-школы: Яндекс Директ, воронка и аналитика"
    Desc  = "Как настроить рекламу онлайн-школы: подготовить воронку и лендинг, запустить Поиск и РСЯ, настроить аналитику, оценивать качество лидов и масштабировать рабочие кампании."
    Images = @("nastroyka-reklamy-onlayn-shkoly-1", "nastroyka-reklamy-onlayn-shkoly-2", "nastroyka-reklamy-onlayn-shkoly-3")
    Alts  = @(
      "Схема воронки рекламы онлайн-школы: реклама, заявка, прогрев и продажа",
      "Сравнение Поиска и РСЯ для рекламы онлайн-школы",
      "Схема укрупнения рекламных кампаний онлайн-школы для накопления данных"
    )
    CardImage = "nastroyka-reklamy-onlayn-shkoly"
  },
  @{
    ...
    Alts  = @(
      "Три жилых комплекса с отдельными рекламными кампаниями и CPL",
      "Воронка продажи новостройки: клик, лид, квалификация, просмотр и сделка",
      "Система рекламы новостройки: Яндекс Директ, страница ЖК, Метрика, CRM и сделка"
    )
    CardImage = "kontekstnaya-reklama-novostroek"
  },
  @{
  ...
  @{
    ...
    Alts  = @(
      "Расчет CR в Яндекс Директе: 10 заявок из 200 кликов дают конверсию 5%",
      "Разница между CR и CPA в Яндекс Директе: конверсия 5% и стоимость заявки 2 000 рублей",
      "Как Яндекс Директ использует конверсии из Метрики для оптимизации рекламной кампании"
    )
  },
  @{
  ...
  @{
    ...
    Alts  = @(
      ...
      "Как выбрать частного специалиста по Яндекс Директ: проверка кейсов, аналитики и личного ведения проекта",
  ...
  ,@{
    Slug  = "reklama-agentstva-nedvizhimosti"
    Title = "Реклама агентства недвижимости: как получать целевые заявки и не сливать бюджет"
    Desc  = "Как рекламировать агентство недвижимости: Яндекс Директ, Поиск и РСЯ, сегментация спроса, посадочные страницы, аналитика и реальные кейсы продвижения недвижимости."
    Images = @("reklama-agentstva-nedvizhimosti-1", "reklama-agentstva-nedvizhimosti-2", "reklama-agentstva-nedvizhimosti-3")
    CardImage = "reklama-agentstva-nedvizhimosti"
    Alts  = @(
      "Сегментация рекламы агентства недвижимости по задачам клиентов",
      "Воронка заявок в недвижимости от рекламы до сделки",
      "Связка эффективной рекламы от предложения до качественного лида"
    )
  }
  ,@{
  ...
  ,@{
    Slug  = "drr-v-reklame"
    Title = "ДРР в рекламе: что это такое, как считать и какой показатель считать нормальным"
    Desc  = "Что такое ДРР в рекламе и маркетинге, формула расчета, примеры и связь с маржинальностью. Как определить допустимый ДРР и использовать его в Яндекс Директе."
    Images = @("01-kak-schitat-drr", "02-drr-i-marzhinalnost", "03-gde-nakhoditsya-drr")
    CardImage = "drr-v-reklame"
    Alts  = @(
      "Формула расчета ДРР на примере рекламных расходов и выручки",
      "Как маржинальность влияет на допустимую долю рекламных расходов",
      "ДРР в цепочке оценки эффективности рекламы от расходов до прибыли"
    )
  }
)
