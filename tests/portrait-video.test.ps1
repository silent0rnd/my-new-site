...
Assert-Match $js 'threshold:\s*0\.25' "Work card visibility threshold must start on entry"
...
Assert-Match $css '\.work-card li:nth-child\(7\)\s*\{\s*--tick-delay:\s*810ms' "Work tick cascade must use 135ms nth-child delays"
